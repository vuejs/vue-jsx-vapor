            ...
            if !has_dynamic_slots {
              ...
              obj.properties.insert(
                ...
                ast.object_property_kind_object_property(
                  ...
                  ast.expression_numeric_literal(SPAN, 1_f64, None, NumberBase::Decimal),
                  false,
                  false,
                  false,
                ),
              ...
              exp = ast.expression_object(
                ...
                ast.vec_from_array([
                  ...
                  ast.object_property_kind_object_property(
                    ...
                    oxc_ast::ast::PropertyKind::Init,
                    ast.property_key_static_identifier(SPAN, "_"),
                    ast.expression_numeric_literal(SPAN, 2_f64, None, NumberBase::Decimal),
                    false,
                    false,
                    false,
                  ),
          ...
          ast.vec1(
            ast.statement_expression(
              ...
              ast.expression_jsx_element(
                ...
                Some(ast.jsx_closing_element(SPAN, ast.jsx_element_name_identifier(SPAN, ""))),
              ),
            ),
          ),
        ),
