...
fn v_if_basic() {
  ...
  (() => {
    ...
    return _openBlock(), _createElementBlock("div", null, [(_openBlock(), _createElementBlock("_Fragment", null, foo ? (_openBlock(), _createBlock(_component__Fragment, { key: 0 }, [_createElementVNode("div", { foo }, "foo", 8, _hoisted_1)])) : _createCommentVNode("", true))), (_openBlock(), _createElementBlock("_Fragment", null, foo ? (_openBlock(), _createElementBlock("span", { key: 1 })) : bar ? (_openBlock(), _createElementBlock("span", { key: 2 })) : (_openBlock(), _createElementBlock("a", { key: 3 }))))]);
  })();
  "#);
}
