  ...
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      ...
      try {
        ...
        if (
          bindingPackageVersion !== '3.3.0-rc.2' &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK &&
          process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0'
        ) {
          throw new Error(
            `Native binding package version mismatch, expected 3.3.0-rc.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
          )
        }
        return binding
      } catch (e) {
...
if (!nativeBinding || forceWasi) {
  ...
  if (!wasiBindingLoaded && (!__napiWasiFlavorRequested || __napiWasiFlavor === 'wasm32-wasi')) {
    ...
    try {
      candidateError = __napiWasiResolveCandidate('./compiler.wasi.cjs', false, [
        './compiler.wasm32-wasi.debug.wasm',
    ...
    try {
      ...
      if (!candidateFailed) {
        if (
          ...
          if (bindingPackageVersion !== '3.3.0-rc.2') {
            throw new Error(
              `WASI binding package version mismatch, expected 3.3.0-rc.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`,
            )
          }
        }
